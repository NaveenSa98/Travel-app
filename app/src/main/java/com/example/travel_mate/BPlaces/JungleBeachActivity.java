...
public class JungleBeachActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String description = "  When it comes to serene and hidden coastal paradises, Jungle Beach stands as an enchanting gem on the southern coast. This secluded haven offers a picturesque expanse of golden sands, where you can immerse yourself in the awe-inspiring beauty of Rumassala Hill on one side and the fascinating Indian Ocean on the other. This writing will take you on a virtual journey to this idyllic destination, exploring its allure, adventure, and aquatic wonders.";
