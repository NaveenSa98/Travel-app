...
public class WaterfallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_waterfall);



        databaseReference = FirebaseDatabase.getInstance().getReference("Places").child("WaterFalls");
        placeListView = findViewById(R.id.placeListView_4);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (final PlaceA place : placeList) {
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(WaterfallActivity.this);
        ...
        placeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (selectedPlace.getName()) {
                    case "Bambarakanda Waterfall":
                        destinationActivity = BambarakandaWaterfallActivity.class;
                        break;
                    case "Dunhinda Waterfall":
                        destinationActivity = DunhindaWaterfallActivity.class;
                        break;
                    case "Gartmore Waterfall":
                        destinationActivity = GartmoreWaterfallActivity.class;
                        break;
                    case "Bomburu Waterfall":
                        destinationActivity = BomburuWaterfallActivity.class;
                        break;
                    case "Dunsinane Waterfall":
                        destinationActivity = DunsinaneWaterfallActivity.class;
                        break;
                }

                // Start the corresponding Activity
                if (destinationActivity != null) {
                    Intent intent = new Intent(WaterfallActivity.this, destinationActivity);
