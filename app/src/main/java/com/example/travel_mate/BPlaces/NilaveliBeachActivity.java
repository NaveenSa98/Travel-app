...
public class NilaveliBeachActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.b_nilavelibeach);
        ...
        slideModels.add(new SlideModel("https://thumbs.dreamstime.com/b/aerial-view-nilaveli-beach-sri-lanka-274444422.jpg", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://www.tamarindholiday.com/upload/destination/gallery/-187026081869_4177059037_1548152491_n.jpg", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://negombotourservice.com/wp-content/uploads/2020/06/nilaweli-beach-05.jpg", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://www.news.lk/media/k2/items/cache/b292b668b51cb8c9a98c649f6a341b0e_XL.jpg", ScaleTypes.FIT));
        ...
        accommodationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String bookingUrl = "https://www.booking.com/searchresults.en-gb.html?ss=Nilaveli+beach&ssne=Nilaveli&ssne_untouched=Nilaveli&label=gog235jc-1DCAEoggI46AdIM1gDaIUBiAEBmAEJuAEXyAEM2AED6AEBiAIBqAIDuAL5z_qpBsACAdICJDgxMTdkMzk1LTNkM2YtNGViNC04OTNjLTUyZTVlMTdjOGNiZdgCBOACAQ&sid=edf2329e549776c19fde29e46829dcdf&aid=397594&lang=en-gb&sb=1&src_elem=sb&src=searchresults&dest_id=328226&dest_type=hotel&ac_position=0&ac_click_type=b&ac_langcode=en&ac_suggestion_list_length=5&search_selected=true&search_pageview_id=5dde8fef06f30200&ac_meta=GhA1ZGRlOGZlZjA2ZjMwMjAwIAAoATICZW46Dk5pbGF2ZWxpIGJlYWNoQABKAFAA&checkin=2023-11-03&checkout=2023-11-04&group_adults=1&no_rooms=1&group_children=0";                // Create an Intent to open a web browser with the Booking.com URL
...
//            double longitude = lastKnownLocation.getLongitude();
    private void openHospitalInGoogleMaps() {
        ...
        double latitude = 8.70;
        double longitude =  81.19;
