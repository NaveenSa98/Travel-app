...
public class BeachActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_beach);



        databaseReference = FirebaseDatabase.getInstance().getReference("Places").child("BeachSides");
        placeListView = findViewById(R.id.placeListView_2);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (final PlaceA place : placeList) {
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(BeachActivity.this);
        ...
        placeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (selectedPlace.getName()) {
                    case "Jungle Beach":
                        destinationActivity = JungleBeachActivity.class;
                        break;
                    case "Dalawella Beach":
                        destinationActivity = DallwellaBeachActivity.class;
                        break;
                    case "Hiriketiya Beach":
                        destinationActivity = HiriketiyaBeachActivity.class;
                        break;
                    case "Mirissa Beach":
                        destinationActivity = MirissaBeachActivity.class;
                        break;
                    case "Nilaveli Beach":
                        destinationActivity = NilaveliBeachActivity.class;
                        break;
                }

                // Start the corresponding Activity
                if (destinationActivity != null) {
                    Intent intent = new Intent(BeachActivity.this, destinationActivity);
