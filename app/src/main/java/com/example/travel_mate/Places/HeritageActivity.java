...
public class HeritageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_heritage);



        databaseReference = FirebaseDatabase.getInstance().getReference("Places").child("Heritages");
        placeListView = findViewById(R.id.placeListView_3);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (final PlaceA place : placeList) {
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(HeritageActivity.this);
        ...
        placeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (selectedPlace.getName()) {
                    case "Anuradhapura":
                        destinationActivity = AnuradhapuraActivity.class;
                        break;
                    case "Polonnaruwa":
                        destinationActivity = PolonnaruwaActivity.class;
                        break;
                    case "Kandy":
                        destinationActivity = KandyActivity.class;
                        break;
                    case "Sigiriya":
                        destinationActivity = SigiriyaActivity.class;
                        break;
                }

                // Start the corresponding Activity
                if (destinationActivity != null) {
                    Intent intent = new Intent(HeritageActivity.this, destinationActivity);
